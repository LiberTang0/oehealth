...
class OeHealthPatient(models.Model):
    ...
    def print_patient_label(self):
        return self.env['report'].get_action(self, 'oehealth.report_patient_label')
...
class OeHealthAppointment(models.Model):
    ...
    name = fields.Char(string='Appointment #', size=64, readonly=True, required=True, default=lambda *a: '/')
